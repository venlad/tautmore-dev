...
import {
    chevRight, select, student, parents,
                ...
                <div className="register-top">
                    <div className="row">
                        ...
                        <div className="col-md-8 col-sm-12">
                            {step > 0 && step < 5 && (
                                <h2>You are registering as a <span>Parent</span></h2>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="option-part">
                    <div className="option-part-head">
                        ...
                        <div className="text-center">
                            <RegisterOption icon={student} title="Student" />
                            <RegisterOption icon={parents} title="Parent" />
                        </div>
                    </div>
                </div>
            )}
