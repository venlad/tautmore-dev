    ...
    <div className="brain-gym-main">
        <div className="row">
            <div className="col-md-4">
                <h3>Brain gym</h3>
                <p>Unlock these chests everyday to earn points and redeem exciting prizes</p>
                <li className="li-one">Level 1 completed</li>
                <li className="li-two"><span />300 XP earned</li>
                <button type="button" className="button-common">Start now <span>{chevRight}</span></button>
