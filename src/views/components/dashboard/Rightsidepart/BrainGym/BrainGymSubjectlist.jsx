...
const BrainGymSubjectlist = ({
    // eslint-disable-next-line react/prop-types
    subjectList, setSelectedSubject, selectedSubject, startChest,
})  => {
                ...
                <div className="dtoggle-bar">
                    {subjectList?.map((item) => (
                        <div key={item?.subject?._id} className="toggle-maths-div">
                            <button
                                className={'toggle-maths-btn'.concat(selectedSubject?._id === item?.subject?._id ? 'mathbtn-act' : 'mathbtn-un')}
                                type="button"
