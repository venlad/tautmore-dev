...
function SubjectModel({ classTitle, handleSubjectModel, showSubjectModel }) {
    return (
        <>
            <Modal
                size="lg"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title id="example-modal-sizes-title-lg">
                        {classTitle}<br /> <span className="subtopic">Trigonometry - Topic 2</span>
                    </Modal.Title>
                </Modal.Header>
                                            ...
                                            <div className="col-sm-12  studentlistdiv">
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-3 progressbarsection ">
                                                        <div className="atteddiv">
                                                        {item.attendance === 'true' ?
                                                        <span className="attendance">
                                                        Present</span> :
                                                        <span className="attendanceAbsent">
                                                        Absent</span> }
                                                        <br /></div>
                                                ...
                                                <div className="col-sm-12 ">
                                                    <Progressbar className="progress-bar-one"
                                                    peronevalue={item.progress}
                                                     perone title="Subject completion" />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 viewassign">
                                                {item.submission === 'true' ? <>
                                                <a href="/">View assignment</a>
                                                <img src={Viewassignmenticon} alt="assignment" />
                                                 </> : <span className="notsubmitted">
                                                 Assignment not submitted</span>}
                                ...
                                <div className="completeddiv">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-10">
                                            ...
                                            Online class completed!</span><br />
                                            <span className="sendassignment">
                                            Please send the assignments to the
                                                students now
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <button type="button" className="button-common">Assign
                                        <span>
                                            ...
                                            >
                                                ...
                                                708l-6 6a.5.5 0 0 1-.708-.
                                                708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                                            </svg>
                                        </span>
                                    </button>
                                </div>
