...
function completeChest(params){
    return fetchWrapper.post(`${baseUrl}/local/api/brainGym/completeChest`, params);
 }
 ...
 function getMasterBrainGymById(params){
    return fetchWrapper.post(`${baseUrl}/local/api/brainGym/getMasterBrainGymById`, params);
 }

 function getBrainGymById(params){
    return fetchWrapper.post(`${baseUrl}/local/api/brainGym/getBrainGymById`, params);
 }

 function getBrainGymAndCheckForDelay(params){
    return fetchWrapper.post(`${baseUrl}/local/api/brainGym/getBrainGymAndCheckForDelay`, params);
 }
